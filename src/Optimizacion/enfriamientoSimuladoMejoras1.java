...
de optimos globales.
Este algoritmo de Enfriamiento Simulado incluye una supuesta mejora que consiste que tras x iteraciones del bucle
interior sin mejoras, el bucle para automaticamente, este numero de iteracciones maximas se introducira como
parametro de entrada */
public class enfriamientoSimuladoMejoras1 {
	...
	//Constructor
	public enfriamientoSimuladoMejoras1(grafo g, problemaOptimizado p){
		this.g= g;
		this.probl=p;
	}
   ...
   (5) numMaxIteraccionesSinMejora: es el numero maximo de interacciones del bucle interior sin mejoras*/
	...
	public estados algoritmoEnfriamientoSimuladoMejoras1(int temperatura, int factor, int nEnfriamientos,
		   int nIteracciones, int numMaxIteracSinMejora){
		...
		for(int i=0; i<= enfriamientos;i++){
			...
			int j=0;		
			/*Bucle interno del algoritmo que se repetira nIteracciones o numMaxIterSinMejoras en caso de no
			  haber mejoras en ese numero de iteracciones. En este bucle calculamos el estado candidato y lo 
			  comparamos con el actual, a continuacion calculamos el incremento de las funciones objetivo y 
			  vemos si lo aceptamos o no llamando a la funcion aceptarCandidato.*/
        ...
        System.out.println("---Enfriamiento Simulado Mejora I---");
