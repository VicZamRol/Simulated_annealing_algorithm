...
iteracciones del bucle exterior se calculara como un tercio del nuemro total de enfriamientos */

public class enfriamientoSimuladoMejoras2 {
	...
	//Constructor
	public enfriamientoSimuladoMejoras2(grafo g, problemaOptimizado p){
		this.g= g;
		this.probl=p;
	}
	...
	public estados algoritmoEnfriamientoSimuladoMejoras2(int temperatura, int factor, int nEnfriamientos, int nIteracciones){
		...
		if(temperaturaAct< factorDesc * enfriamientos){
			...
			System.out.println("---Enfriamiento Simulado Mejora II---");
